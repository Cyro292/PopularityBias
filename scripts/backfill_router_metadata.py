...
Usage::
    ...
    python scripts/backfill_router_metadata.py --dry-run
    python scripts/backfill_router_metadata.py            # writes metadata.json
...
# Make the repo importable when invoked as ``python scripts/...``.
