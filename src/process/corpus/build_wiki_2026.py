...
def main() -> None:
    ...
    xml_path = DATA_DIR / "popularity" / "enwiki-2026-04-01-p10p1141529.xml"
    output_path = DATA_DIR / "wiki_2026" / "wiki_2026_corpus.parquet"
    views_2026_path = DATA_DIR / "popularity" / "en_wikipedia-202601.parquet"
